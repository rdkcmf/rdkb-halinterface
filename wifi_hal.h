...
/**
* @brief This call back will be invoked when driver detect the radar noise.
* If there are multiple channels have the radar noise, channel_number could be like "120,124,128"
*
* @param[in] channel_number   Channel number to detect
*
* @return The status of the operation
* @retval RETURN_OK if successful
* @retval RETURN_ERR if any error is detected
...
*
* @param[in] callback_proc  Callback function
*
*/
